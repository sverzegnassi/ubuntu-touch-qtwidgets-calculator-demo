...
import ubuntu-touch-qtwidgets-calculator-demo
...
class BaseTestCase(AutopilotTestCase):
    ...
    click_package = '{0}.{1}'.format('ubuntu-touch-qtwidgets-calculator-demo', 'sverzegnassi')

    def setUp(self):
        super(BaseTestCase, self).setUp()
        self.launcher, self.test_type = self.get_launcher_and_type()
        self.app = ubuntu-touch-qtwidgets-calculator-demo.TouchApp(self.launcher(), self.test_type)
